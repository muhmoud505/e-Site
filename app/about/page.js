      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-3xl mx-auto bg-white p-6 md:p-8 rounded-lg shadow-md text-center">
          ...
          <div className="text-right text-gray-700 space-y-4">
            <p>
              مرحبًا بكم في <strong>متجر الأناقة</strong>. نحن نؤمن بأن الأناقة ليست مجرد مظهر، بل هي أسلوب حياة. تأسس متجرنا بشغف لتقديم أحدث صيحات الموضة بجودة عالية وأسعار تنافسية.
            </p>
            <p>
